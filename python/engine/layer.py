...
import engine.attention  # noqa: F401  触发注意力构建器注册（layer 经 registry 分发）
from engine.moe import DenseBlock, MLP, SparseMoeBlock, TopKRouter, torch_weight
from core.norm import rms_norm, rms_norm_add
from engine.registry import get_attention, get_moe_format, list_attentions, list_moe_formats
